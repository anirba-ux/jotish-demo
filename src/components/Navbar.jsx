...
const Navbar = () => {
  ...
  // Mock login/logout toggle function (replace with actual logic)
        ...
        <div className="hidden md:flex">
          {isAuthenticated ? (
            <button
              ...
              className="bg-red-400 text-white font-semibold py-2 px-6 rounded-full hover:bg-red-500 transition"
            >
              Logout
            </button>
          ) : (
