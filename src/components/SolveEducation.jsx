...
import { eduimg1, eduimg2, eduimg3 } from "../assets";
import { useNavigate } from "react-router-dom";

const SolveEducation = () => {
  const navigate = useNavigate();

  const handleConsultAstrologer = () => {
    navigate('/consult-astrologer', { state: { fromSolveEducation: true } });
  };
